	...
	implements AccountPersistService
{
		...
		throws AccountPersistException
	{
		...
		for (Element accountEle : (List<Element>)accountsEle.getElements()) 
		{
	...
	private Account buildAccount(Element element){
		...
		account.setActivated(("true".equals(element.elementText(ELEMENT_ACCOUNT_ID)) ? true : false);
	...
	private Element buildAccountElement(Account account)
	{
		...
		element.addElements(ELEMENT_ACCOUNT_ID).setText(account.getId());
		element.addElements(ELEMENT_ACCOUNT_NAME).setText(account.getName());
		element.addElements(ELEMENT_ACCOUNT_EMAIL).setText(account.getEmail());
		element.addElements(ELEMENT_ACCOUNT_PASSWORD).setText(account.getPassword());
		element.addElements(ELEMENT_ACCOUNT_ACTIVATED).setText(account.getActivated() ? "true" : "false");
